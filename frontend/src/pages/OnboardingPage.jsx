...
const OnboardingPage = () => {
  const {authUser} = useAuthUser(); // Fetching the authenticated user
  ...
  const {mutate:onboardingMutation, isPending} =  useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({ queryKey: ['authUser'] }); // Invalidate authUser query to refresh user data
    },
    onError: (error) => {
  ...
  const handleRandomAvatar = () => {
    ...
    const randomAvatar = `https://avatar.iran.liara.run/public/${idx}.svg`;
